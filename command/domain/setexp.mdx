...
- The request data will be saved and recorded in a excel table called **"Request_TransferInDomain"**, which you can view [here](https://superreseller-qa.nominus.host/requests/domain).
- The request data will have a status of **"Successful"** since the command's "**Assume_Success"** field is set to **"Yes."**