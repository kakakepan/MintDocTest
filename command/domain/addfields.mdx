...
The **"AddFieldsToPendingRequest"** command in the SuperReseller dashboard allows SuperResellers to add additional fields to a pending domain request. It allows for the inclusion of specific field types defined in the **"FieldType"** section. The **"AddFieldsToPendingRequest"** command is located within the **"PendingRequests"** subcategory of the **"Domain"** category in Swagger.
