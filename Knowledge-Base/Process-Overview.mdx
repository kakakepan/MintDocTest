...
| Hosting  | Commands related to hosting management. |
| Requests | Commands related to command requests.   |
...
Within the **"Process Overview"** option, the **"Contact Portfolio"** represents the contact information associated with domains. It can be created and modified through specific commands, with statuses indicating its usability.
