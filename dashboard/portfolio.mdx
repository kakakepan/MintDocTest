...
4. When you click on the number of **"active"** or **"inactive"** domains, you will be redirected to a new page that displays relevant data and insights about the respective domain status.
