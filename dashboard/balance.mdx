...
| ---------------------------------- | -------------------------------------------------------------------- |
| If the balance is positive         | <span style="color: green;">`Display the value in **green**.`</span> |
| If the balance is negative or zero | <span style="color:red">`Display the value in **red**.`</span>       |
