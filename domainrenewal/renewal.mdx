...
1. **Eligibility**: Only active domains can be renewed. (Special case for domains with the "Expired-Recoverable" status, please see [here](/domainrenewal/considerations).)
